let cityMap = new Map([    ["Indian Institute of Information Technology", new Map([        ["Lohia Park", 1.3],
        ["Amul Dairy", 1.8],
        ["Fun Republic Mall", 2.4],
        ["Phoenix United Mall", 2.9],
        ["Hazratganj", 6.8]
    ])],
    ["Lohia Park", new Map([        ["Indian Institute of Information Technology", 1.3],
        ["Amul Dairy", 2.5],
        ["Ambedkar Park", 4.2]
    ])],
    ["Amul Dairy", new Map([        ["Indian Institute of Information Technology", 1.8],
        ["Lohia Park", 2.5],
        ["Janeshwar Mishra Park", 8.2],
        ["Hazratganj", 6.5]
    ])],
    ["Fun Republic Mall", new Map([        ["Indian Institute of Information Technology", 2.4],
        ["Phoenix United Mall", 1.5],
        ["Hazratganj", 7.1]
    ])],
    ["Phoenix United Mall", new Map([        ["Indian Institute of Information Technology", 2.9],
        ["Fun Republic Mall", 1.5],
        ["Hazratganj", 7.7]
    ])],
    ["Hazratganj", new Map([        ["Indian Institute of Information Technology", 6.8],
        ["Amul Dairy", 6.5],
